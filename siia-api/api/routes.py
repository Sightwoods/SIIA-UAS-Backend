...
login_model = rest_api.model('LoginModel', {"account_number": fields.String(required=True, min_length=4, max_length=64),
...
class Login(Resource):
    ...
    def post(self):
        ...
        payload = {'account_number': _account_number, 'exp': datetime.utcnow() + timedelta(minutes=30)}
